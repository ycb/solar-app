...
## Project overview
- Goal: create a prototype as part of the interview process for Head of Product at Solar App Foundation
- Details: You’re developing the first version of a mobile app that helps solar installers document their completed installation for inspection purposes. In this specific case, the installers you’re working with are installing residential rooftop solar and a battery storage system on single-family homes, where they are working onsite, often time-constrained, and working alone or with a small crew. The goal of the app is to help installers capture the right information the first time, reduce back-and-forth with inspectors, increase confidence that an installation is inspection-ready, and do this without requiring installers to be solar code experts.
- Orientation docs: `WORKFLOW.md`, `docs/JD.md`, `docs/INSTRUCTIONS.md`, `docs/BASELINE.md`, `docs/PRODUCT_GOALS.md`, `docs/PROJECT_DEFAULTS.md`, `docs/WIREFRAMES.md`, and `docs/SLACK.md`.
